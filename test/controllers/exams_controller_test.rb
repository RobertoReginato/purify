...
class ExamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post exams_url, params: { exam: { area: @exam.area, instructions: @exam.instructions, name: @exam.name, requires_responsible: @exam.requires_responsible, short_name: @exam.short_name } }
    end
  ...
  test "should update exam" do
    patch exam_url(@exam), params: { exam: { area: @exam.area, instructions: @exam.instructions, name: @exam.name, requires_responsible: @exam.requires_responsible, short_name: @exam.short_name } }
